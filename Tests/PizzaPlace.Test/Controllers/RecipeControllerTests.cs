...
public class RecipeControllerTests
{
    ...
    {
        // Arrange
        Recipe recipe = new(PizzaRecipeType.StandardPizza, [new(IngredientType.Dough, 1)], 12);
    ...
    {
        // Arrange
        Recipe oldRecipe = new(PizzaRecipeType.StandardPizza, [new(IngredientType.Dough, 1)], 12);

        Recipe newRecipe = new(PizzaRecipeType.StandardPizza,
                                    [new(IngredientType.Dough, 1), new(IngredientType.Tomatoes, 1)],
                                    12);
